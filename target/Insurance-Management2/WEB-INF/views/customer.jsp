        ...
        <div class="col-lg-4">
          <div class="card" style="width: 18rem; margin-left: 50px">
            <div class="card-body">
              ...
              <a href='http://localhost:8080/Insurance-Management2/applyPolicyPage/${username}' class="btn btn-primary"
                >Apply Policy Page</a
              >
            </div>
          </div>
        ...
        <div class="col-lg-4">
          <div class="card" style="width: 18rem; margin-left: 50px">
            <div class="card-body">
              ...
              <a href='http://localhost:8080/Insurance-Management2/getPremiumPage/${username}' class="btn btn-primary"
